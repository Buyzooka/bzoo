...
const contractPath_default = './contracts/BuyzookaToken.sol';
...
function compileContract(contractPath, contractFile) {
    ...
    const abi = compiledObject.contracts["BuyzookaToken.sol"]["BuyzookaToken"].abi;
...
function substituteDependencyLine(line) {
    if (line.indexOf('PauserRole.sol') >= 0)
        return ('import "../../../BuyzookaToken/contracts/PauserRole.sol"');
    else
        return line;
}
